from prepare_examples_exp2 import df_fin
from model_pipeline_exp2 import obtain_predictions
import pandas as pd

pd.set_option('display.max_colwidth', None)

nat_only_df = df_fin[df_fin['cat'] == 'NAT']
...
for model in models:
    results = obtain_predictions(nat_only_df, model, 5)
